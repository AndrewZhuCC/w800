...
//static int decode_total_time = 0;
#define ALLOC_SUPPORTED
/**************************************************************************************
...
{
    MP3DecInfo *mp3DecInfo = 0;
    //decode_total_time = 0;

    //printf("+++[%s]%d+++\n", __func__, __LINE__);
#ifdef ALLOC_SUPPORTED
    mp3DecInfo = AllocateBuffers();
#else
    mp3DecInfo = InitBuffers();
#endif
 ...
 **************************************************************************************/
static int MP3FindFreeSync(const unsigned char *buf, unsigned char firstFH[4], int nBytes)
{
    int offset = 0;
...
int MP3Decode(HMP3Decoder hMP3Decoder, unsigned char **inbuf, int *bytesLeft, short *outbuf, int useSize)
{
    ...
    *bytesLeft -= (fhBytes + siBytes);
    ...
    //printf("*G: %d, C: %d* ", mp3DecInfo->nGrans, mp3DecInfo->nChans);
    ...
    //t2 = gx_get_time_ms() - t;
    //decode_total_time += t2;
    //printf("%u %u\n", t2, decode_total_time);
    //printf("  %u\n", gx_get_time_ms() - t2);
    //t = gx_get_time_ms();
    //printf("\n");
    return ERR_MP3_NONE;
