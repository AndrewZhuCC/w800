...
/** invalid SSID */
#define	UNI_WIFI_ERR_SSID		   -1
/** invalid key */
#define	UNI_WIFI_ERR_KEY			   -2
/** wps is busing */
#define UNI_WIFI_WPS_BUSY		   -3
/** scan is busing */
#define UNI_WIFI_SCANNING_BUSY	   -4
/** station is connecting */
#define UNI_WIFI_STA_BUSY	       -5

/* error number definition */
/** no error */
#define     UNI_WIFI_ENOERR          0
/** ap not exist */
#define     UNI_WIFI_ENOAP           1
/** pre-shared key may be incorrect */
#define     UNI_WIFI_EKEY            2
/** Low signal intensity */
#define     UNI_WIFI_ELSI            3
...
enum tls_wifi_auth_mode {
    UNI_WIFI_AUTH_MODE_OPEN              = 0, /**< authenticate mode : open */
    UNI_WIFI_AUTH_MODE_WEP_AUTO          = 3, /**< authenticate mode : wep (open or/and shared...) */
    UNI_WIFI_AUTH_MODE_WPA_PSK_TKIP      = 4, /**< authenticate mode : wpa psk rc4 */
    UNI_WIFI_AUTH_MODE_WPA_PSK_CCMP      = 8, /**< authenticate mode : wpa psk aes */
    UNI_WIFI_AUTH_MODE_WPA_PSK_AUTO      = (UNI_WIFI_AUTH_MODE_WPA_PSK_TKIP | UNI_WIFI_AUTH_MODE_WPA_PSK_CCMP), /**< authenticate mode : wpa psk, tkip and aes */
    UNI_WIFI_AUTH_MODE_WPA2_PSK_TKIP     = 16, /**< authenticate mode : wpa2 psk rc4 */
    UNI_WIFI_AUTH_MODE_WPA2_PSK_CCMP     = 32, /**< authenticate mode : wpa2 psk aes */
    UNI_WIFI_AUTH_MODE_WPA2_PSK_AUTO     = (UNI_WIFI_AUTH_MODE_WPA2_PSK_TKIP | UNI_WIFI_AUTH_MODE_WPA2_PSK_CCMP), /**< authenticate mode : wpa2 psk, tkip and aes */
    UNI_WIFI_AUTH_MODE_WPA_WPA2_PSK_TKIP = (UNI_WIFI_AUTH_MODE_WPA_PSK_TKIP | UNI_WIFI_AUTH_MODE_WPA2_PSK_TKIP),
    UNI_WIFI_AUTH_MODE_WPA_WPA2_PSK_CCMP = (UNI_WIFI_AUTH_MODE_WPA_PSK_CCMP | UNI_WIFI_AUTH_MODE_WPA2_PSK_CCMP),
    UNI_WIFI_AUTH_MODE_WPA_WPA2_PSK_AUTO = (UNI_WIFI_AUTH_MODE_WPA_PSK_AUTO | UNI_WIFI_AUTH_MODE_WPA2_PSK_AUTO), /**< authenticate mode : wpa and wpa2, tkip and aes */
    UNI_WIFI_AUTH_MODE_UNKNOWN           = 128
};

/** Wi-Fi states */
enum tls_wifi_states {
	UNI_WIFI_DISCONNECTED,      /**< Disconnected state */
	UNI_WIFI_SCANNING,          /**< Scanning for a network */
	UNI_WIFI_JOINING,           /**< Trying to join with a BSS/SSID */
	UNI_WIFI_JOINED             /**< All authentication completed */
};

/** frame type of the manager */
enum tls_wifi_mgmt_type {
    UNI_WIFI_MGMT_TYPE_ASSOC_REQ	   = 0x0000,    /**< association request frame */
    UNI_WIFI_MGMT_TYPE_ASSOC_RESP   = 0x0010,    /**< association response frame */
    UNI_WIFI_MGMT_TYPE_REASSOC_REQ  = 0x0020,    /**< reassociation request frame */
    UNI_WIFI_MGMT_TYPE_REASSOC_RESP = 0x0030,    /**< reassociation response frame */
    UNI_WIFI_MGMT_TYPE_PROBE_REQ    = 0x0040,    /**< probe request frame */
    UNI_WIFI_MGMT_TYPE_PROBE_RESP   = 0x0050,    /**< probe response frame */
    UNI_WIFI_MGMT_TYPE_BEACON       = 0x0080,    /**< beacon frame */
    UNI_WIFI_MGMT_TYPE_ATIM         = 0x0090,    /**< ATIM frame */
    UNI_WIFI_MGMT_TYPE_DISASSOC     = 0x00A0,    /**< disassociation frame */
    UNI_WIFI_MGMT_TYPE_AUTH         = 0x00B0,    /**< authentication frame */
    UNI_WIFI_MGMT_TYPE_DEAUTH       = 0x00C0,    /**< deauthentication frame */
    UNI_WIFI_MGMT_TYPE_ACTION       = 0x00D0     /**< action frame */
};

/** Wi-Fi ransport rate */
enum tls_wifi_tx_rate {
    UNI_WIFI_TX_RATEIDX_1M = 0,    /**< 11b, 1M */
    UNI_WIFI_TX_RATEIDX_2M,        /**< 11b, 2M */
    UNI_WIFI_TX_RATEIDX_5_5M,      /**< 11b, 5.5M */
    UNI_WIFI_TX_RATEIDX_11M,       /**< 11b, 11M */
    UNI_WIFI_TX_RATEIDX_6M,        /**< 11g, 6M */
    UNI_WIFI_TX_RATEIDX_9M,        /**< 11g, 9M */
    UNI_WIFI_TX_RATEIDX_12M,       /**< 11g, 12M */
    UNI_WIFI_TX_RATEIDX_18M,       /**< 11g, 18M */
    UNI_WIFI_TX_RATEIDX_24M,       /**< 11g, 24M */
    UNI_WIFI_TX_RATEIDX_36M,       /**< 11g, 36M */
    UNI_WIFI_TX_RATEIDX_48M,       /**< 11g, 48M */
    UNI_WIFI_TX_RATEIDX_54M,       /**< 11g, 54M */
    UNI_WIFI_TX_RATEIDX_MCS0,      /**< 11n-20MHz, mcs0 */
    UNI_WIFI_TX_RATEIDX_MCS1,      /**< 11n-20MHz, mcs1 */
    UNI_WIFI_TX_RATEIDX_MCS2,      /**< 11n-20MHz, mcs2 */
    UNI_WIFI_TX_RATEIDX_MCS3,      /**< 11n-20MHz, mcs3 */
    UNI_WIFI_TX_RATEIDX_MCS4,      /**< 11n-20MHz, mcs4 */
    UNI_WIFI_TX_RATEIDX_MCS5,      /**< 11n-20MHz, mcs5 */
    UNI_WIFI_TX_RATEIDX_MCS6,      /**< 11n-20MHz, mcs6 */
    UNI_WIFI_TX_RATEIDX_MCS7,      /**< 11n-20MHz, mcs7 */
    UNI_WIFI_TX_RATEIDX_MCS8,      /**< 11n-40MHz, mcs8 */
    UNI_WIFI_TX_RATEIDX_MCS9,      /**< 11n-40MHz, mcs9 */
    UNI_WIFI_TX_RATEIDX_MCS10,     /**< 11n-40MHz, mcs10 */
    UNI_WIFI_TX_RATEIDX_MCS11,     /**< 11n-40MHz, mcs11 */
    UNI_WIFI_TX_RATEIDX_MCS12,     /**< 11n-40MHz, mcs12 */
    UNI_WIFI_TX_RATEIDX_MCS13,     /**< 11n-40MHz, mcs13 */
    UNI_WIFI_TX_RATEIDX_MCS14,     /**< 11n-40MHz, mcs14 */
    UNI_WIFI_TX_RATEIDX_MCS15,     /**< 11n-40MHz, mcs15 */
    UNI_WIFI_TX_RATEIDX_MCS32      /**< invalid rate */
};

enum tls_wifi_oneshot_result_type {
    UNI_WIFI_ONESHOT_TYPE_SSIDPWD,
    UNI_WIFI_ONESHOT_TYPE_CUSTOMDATA
};

enum tls_wifi_client_event_type {
    UNI_WIFI_CLIENT_EVENT_ONLINE,
    UNI_WIFI_CLIENT_EVENT_OFFLINE
};
 ...
 * @param          None
 *
 * @retval         UNI_SUCCESS     				start scan
 * @retval         UNI_WIFI_SCANNING_BUSY     	scanning
 ...
 *
 * @retval         UNI_WIFI_ERR_SSID     SSID is NULL
 * @retval         UNI_WIFI_ERR_KEY      key info not correct
 * @retval         UNI_SUCCESS       	soft ap create OK
 * @retval         UNI_WIFI_STA_BUSY     station is connecting
 *
 * @note           None
 */
 ...
 *
 * @retval         UNI_SUCCESS     	IBSS join or create ok
 * @retval         UNI_WIFI_ERR_SSID SSID is NULL
 * @retval         UNI_WIFI_ERR_KEY  key info not correct
 *
 ...
 *
 * @retval         UNI_SUCCESS    config ok, wifi will start to connect AP;
 * @retval         UNI_FAILED     parameter wrong
 *
 ...
 * @retval         UNI_SUCCESS        success
 * @retval         UNI_FAILED	     failed
 * @retval         UNI_WIFI_WPS_BUSY	 last WPS process is not finished;
 *
 ...
 * @param          None
 *
 * @retval         Error Number(UNI_WIFI_ENOERR,UNI_WIFI_ENOAP,
 *								UNI_WIFI_EKEY,UNI_WIFI_ELSI)
 *
 * @note           None
 */
 ...
 *
 * @param[in]      eno  error number(UNI_WIFI_ENOERR,UNI_WIFI_ENOAP,
 *                                   UNI_WIFI_EKEY,UNI_WIFI_ELSI)
 *
