 ...
 * @note           None
 */
int uni_sd_card_set_bus_width(uint32_t rca, uint8_t bus_width);
 ...
 * @note           None
 */
int uni_sd_card_block_read(uint32_t sd_addr, char *buf);
 ...
 * @note           None
 */
int uni_sd_card_block_write(uint32_t rca, uint32_t sd_addr, char *buf);
 ...
 * @note           None
 */
int uni_sd_card_blocks_read(uint32_t sd_addr, char *buf, uint32_t buflen);
 ...
 * @note           None
 */
int uni_sd_card_blocks_write(uint32_t rca, uint32_t sd_addr, char *buf, uint32_t buflen);
