...
#define UNI_SC_RST_PIN		UNI_IO_PB_23 //(23)    
#define UNI_SC_PWR_PIN		UNI_IO_PB_24 //(29)	

#define UNI_SC_DEFAULT_FD	(372)
 ...
 * @retval
 */
void uni_sc_io_clk_config(uint8_t mode);
 ...
 * @retval
 */
void uni_sc_set_bgt(uint8_t bgt);
 ...
 * @retval
 */
void uni_sc_tx_retry_times(uint8_t count);
 ...
 * @retval
 */
void uni_sc_rx_retry_times(uint8_t count);
 ...
 * @retval
 */
void uni_sc_set_etu(uint16_t etu);
 ...
 * @retval
 */
void uni_sc_set_frequency(uint32_t freq);
 ...
 * @retval
 */
static inline void uni_sc_parity_recv(bool bl)
{
 ...
 * @retval
 */
static inline void uni_sc_7816_mode(bool bl)
{
 ...
 * @retval
 */
static inline void uni_sc_set_guardtime(uint8_t gt)
{
 ...
 * @retval
 */
static inline void uni_sc_set_bcwt(uint32_t bwt)
{
 ...
 * @retval
 */
static inline void uni_sc_tx_errsignal_mask(bool bl)
{
 ...
 * @retval
 */
static inline void uni_sc_set_protocol(bool bl)
{
 ...
 *		0--- T0 protocol
 */
static inline uint8_t uni_sc_get_protocol()
{
 ...
 * @retval
 */
static inline void uni_sc_clk_enable(bool bl)
{
