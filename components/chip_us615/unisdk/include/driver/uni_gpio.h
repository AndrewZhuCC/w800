...
enum tls_gpio_dir {
    UNI_GPIO_DIR_OUTPUT,    /**< output */
    UNI_GPIO_DIR_INPUT      /**< input */
};

/** Indicating gpio attribute */
enum tls_gpio_attr {
    UNI_GPIO_ATTR_FLOATING,    /**< floating status */
    UNI_GPIO_ATTR_PULLHIGH,    /**< pull high */
    UNI_GPIO_ATTR_PULLLOW      /**< pull low */
};

/** Indicating gpio interrupt trigger type */
enum tls_gpio_irq_trig {
    UNI_GPIO_IRQ_TRIG_RISING_EDGE,    /**< rising edge arises the interrupt */
    UNI_GPIO_IRQ_TRIG_FALLING_EDGE,   /**< falling edge arises the interrupt */
    UNI_GPIO_IRQ_TRIG_DOUBLE_EDGE,    /**< both rising edge and falling edge arise the interrupt */
    UNI_GPIO_IRQ_TRIG_HIGH_LEVEL,     /**< high power level arises the interrupt */
    UNI_GPIO_IRQ_TRIG_LOW_LEVEL       /**< low power level arises the interrupt */
};
