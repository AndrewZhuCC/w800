...
{
    UNI_PWM_OUT_MODE_BRAKE = 0, /**< brake mode */
    UNI_PWM_OUT_MODE_ALLSYC,    /**< all synchronous mode */
    UNI_PWM_OUT_MODE_2SYC,      /**< two channel synchronous mode */
    UNI_PWM_OUT_MODE_MC,        /**< complementary mode */
    UNI_PWM_OUT_MODE_INDPT      /**< independent mode */
};

/** interrupt type for capture mode */
enum tls_pwm_cap_int_type{
    UNI_PWM_CAP_RISING_EDGE_INT,         /**< rising edge arises the interrupt */
    UNI_PWM_CAP_FALLING_EDGE_INT,        /**< falling edge arises the interrupt */
    UNI_PWM_CAP_RISING_FALLING_EDGE_INT, /**< both rising edge and falling edge arise the interrupt */
    UNI_PWM_CAP_DMA_INT                  /**< dma request */
};

/** pwm output status */
enum tls_pwm_out_en_state{
    UNI_PWM_OUT_EN_STATE_TRI,    /**< set tristate status */
    UNI_PWM_OUT_EN_STATE_OUT     /**< set output status */
};

/** pwm count mode */
enum tls_pwm_cnt_type{
    UNI_PWM_CNT_TYPE_EDGE_ALLGN_CAP,     /**< edge alignment(only capture mode) */
    UNI_PWM_CNT_TYPE_EDGE_ALIGN_OUT,     /**< edge alignment(only output mode) */
    UNI_PWM_CNT_TYPE_CENTER_ALIGN        /**< central alignment */
};

/** pwm cycle type */
enum tls_pwm_loop_type{
    UNI_PWM_LOOP_TYPE_SINGLE,    /**< single mode */
    UNI_PWM_LOOP_TYPE_LOOP       /**< auto load */
};

/** pwm waveform inversion mode */
enum tls_pwm_waveform_inversion{
    UNI_PWM_WAVEFORM_NOINVERSION,    /**< not inverse */
    UNI_PWM_WAVEFORM_INVERSION       /**< inversion */
};

/** pwm output level in the brake mode */
enum tls_pwm_brake_out_level{
    UNI_PWM_BRAKE_OUT_HIGH,          /**< output high level */
    UNI_PWM_BRAKE_OUT_LOW            /**< output low  level */
};
