 ...
 * @file    uni_config.h
 *
 * @brief   chip inferface configure
 *
 */
...
#define UNI_CONFIG_DEBUG_UART1							CFG_OFF/*PRINTF PORT USE UART1*/
/**Driver Support**/
...
#define TLS_CONFIG_DHCP_OPTION60						"Unisound:US615_01"
...
#include "uni_os_config.h"  //if you want to use source code,please open
#include "uni_wifi_config.h"

#include "uni_ram_config.h"
