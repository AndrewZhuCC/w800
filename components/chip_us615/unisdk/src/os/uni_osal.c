...
#ifndef UNI_OS_RTOS_H
#define UNI_OS_RTOS_H
      ...
      u32 flag)
{
    ...
    else
    {
        ...
        if (4 == prio)
            ...
            pname = "uni_supplicant";
        else if (14 == prio)
            pname = "uni_supplicant_timer";
        else if (28 == prio)
            pname = "uni_plcp";
        else
#endif
...
#endif /*end of CONFIG_KERNEL_NONE */

#endif /* end of UNI_OSAL_RTOS_H */
