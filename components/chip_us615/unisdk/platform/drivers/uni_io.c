...
static void io_cfg_option1(enum tls_io_name name)
{
    ...
    if (name >= UNI_IO_PB_00)
    {
        pin    = name - UNI_IO_PB_00;
...
static void io_cfg_option6(enum tls_io_name name)
{
	...
	if (name >=UNI_IO_PA_01 && name <= UNI_IO_PA_04) /*pulldown for adc*/
	{
...
{
    if (UNI_IO_OPTION1 == option)
        io_cfg_option1(name);
    else if (UNI_IO_OPTION2 == option)
        io_cfg_option2(name);
    else if (UNI_IO_OPTION3 == option)
        io_cfg_option3(name);
    else if (UNI_IO_OPTION4 == option)
        io_cfg_option4(name);
    else if (UNI_IO_OPTION5 == option)
        io_cfg_option5(name);
    else if (UNI_IO_OPTION6 == option)
        io_cfg_option6(name);
    else
