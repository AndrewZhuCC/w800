...
#else
#define log_debug(mod, fmt, ...)    LOGD(mod, fmt, ##__VA_ARGS__)
#endif
#define log_info(mod, fmt, ...)     LOGI(mod, fmt, ##__VA_ARGS__)
#define log_warning(mod, fmt, ...)  LOGW(mod, fmt, ##__VA_ARGS__)
#define log_err(mod, fmt, ...)      LOGE(mod, fmt, ##__VA_ARGS__)
#define log_crit(mod, fmt, ...)     LOGF(mod, fmt, ##__VA_ARGS__)
